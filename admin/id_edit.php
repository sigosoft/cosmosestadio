...
$sql="SELECT * FROM users WHERE UserID='$member_id'";
...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE users SET IdentityCard='$IDProof', SQLStatus='$sql'  WHERE UserID='$member_id'";

     if (mysqli_query($conn, $update))
    {
     
    header("location:image_edit.php?id=$member_id");
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image"> ID Proof <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="image" name="IDProof" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
