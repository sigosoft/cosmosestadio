...
$sql="INSERT INTO payment_packages(Sports, TimeSpan, Amount) VALUES ('$Sports', '$TimeSpan','$Amount')";
...
if (mysqli_query($conn, $sql))
 {
    echo "<script> alert('Payment Plan Added Successfully');window.location.href = 'manage_plans.php';</script>";
 } 
