...
$sql="SELECT family_membership.*, users.* FROM family_membership INNER JOIN users ON users.UserID=family_membership.MemberID WHERE family_membership.Type='Primary'";
