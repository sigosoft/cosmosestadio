...
$sql="INSERT INTO payment_history(CustomerType, Name, Mobile, Email, Sports, TimeSpan, Amount, Tax, Grandtotal, CustomerGST,  PaymentExpiryDate, Address, State) VALUES ('$CustomerType', '$GuestName','$GuestMobile', '$GuestEmail','$GuestSports', '$GuestTimeSpan','$GuestTotal', '$GuestTax', '$GuestGrand', '$GuestGST', '$current', '$GuestAddress', '$GuestState')";
...
$sql="INSERT INTO payment_history(CustomerType, MemberID, RegisterNo, Name, Mobile, Email, Sports, TimeSpan, Amount, Tax, Grandtotal, CustomerGST, PaymentExpiryDate, Address, State) VALUES ('$SelectedTypememb', '$MemberID', '$RegisterNo', '$Name','$Mobile', '$Email','$Sports', '$TimeSpan','$Amount', '$Tax', '$Grand', '$memberGST', '$PaymentExpiryDate','$MemberAddress', '$MemberState')";
