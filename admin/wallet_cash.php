...
$sql="SELECT * FROM wallet_reduction WHERE DATE(`Timestamp`)='$current' AND TransName='wallet'";
...
if(isset($_POST['submit']))
{
 ...
 $sql="SELECT * FROM wallet_reduction  WHERE (DATE(`Timestamp`) >= '$from' AND DATE(`Timestamp`) <= '$to') AND TransName='wallet'";
                ...
                <div class="x_panel p-btm" >
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      {
                          $UserIDE=$row['UserID'];
                          $users=mysqli_query($conn,"SELECT * FROM users WHERE UserID='$UserIDE'");
                          $rower=mysqli_fetch_assoc($users);
                          $Name=$rower['Name'];
                          $RegisterNo=$rower['RegisterNo'];
