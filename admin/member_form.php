...
<section class="main" id="divToPrint">
        	<div class="header">
        		...
        		<p> <strong>Cosmos Estadio<br>Florican road, Malaparamba<br>Kozhikode. Ph : 9539 444 777</strong></p>
        	</div>
        	<div class="content">
        		<div class="row">
        		...
        		<div class="row">
        			<div class="col-md-12"><h4 class="text-center">Sports Details</h4></div>
        			<div class="col-md-12">
        				<table width="100%">
