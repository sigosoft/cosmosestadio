...
$Validate=mysqli_query($conn,"SELECT * FROM users WHERE Phone='$Phone' OR Email='$Email' OR LoyalityCard='$LoyalityCard'");
...
if(mysqli_num_rows($Validate)<=0) 
{
   ...
   $insert="INSERT INTO users(RegisterNo, Name, Phone, Email, Place, Gender, UserImage, IdentityCard, BloodGroup, DOB, Notes, MaritalStatus, FamilyDetails, Occupation, KnownFrom, membertypo, RefferedBy, RegisteredThrough, LoyalityCard, SQLStatus) VALUES ('$RegisterNo', '$Name', '$Phone', '$Email', '$Place', '$Gender', '$UserImage', '$IDProof', '$BloodGroup', '$DOB','$Notes', '$MaritalStatus', '$FamilyDetails', '$Occupation', '$KnownFrom', '$membertypo', '$RefferedBy', 'Estadio', '$LoyalityCard', 1)";
    ...
    $RefererID=$Row['UserID'];
       ...
       $insert="INSERT INTO users(RegisterNo, Name, Phone, Email, Place, Gender, UserImage, IdentityCard, BloodGroup, DOB, Notes, MaritalStatus, FamilyDetails, Occupation, KnownFrom, membertypo, RefferedBy, RegisteredThrough, LoyalityCard, SQLStatus) VALUES ('$RegisterNo', '$Name', '$Phone', '$Email', '$Place', '$Gender', '$UserImage', '$IDProof', '$BloodGroup', '$DOB', '$Notes', '$MaritalStatus', '$FamilyDetails', '$Occupation', '$KnownFrom', '$membertypo', '$RefererID', 'Estadio', '$LoyalityCard', 1)";
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="Place" required="required" name="Place" class="form-control col-md-7 col-xs-12" rows="8"></textarea>
                        </div>
                      </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="Notes" required="required" name="Notes" class="form-control col-md-7 col-xs-12" rows="8"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="FamilyDetails" required="required" name="FamilyDetails" class="form-control col-md-7 col-xs-12" rows="8"></textarea>
                        </div>
                      </div>
